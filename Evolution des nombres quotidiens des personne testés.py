...
fig13.add_trace(go.Scatter(x=time_series_dates.index, y=time_series_dates['P'], fill='tozeroy'))
fig13.update_layout(title='Evolution des nombres quotidiens de personnes testés en France')
fig13.show()
